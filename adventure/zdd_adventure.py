...
class ZDDAdventure:
    ...
    def create_floors(self):
        ...
        nintendo_switch = Item("Nintendo Switch", "A gaming console. Playing on a big TV screen would be nice...", movable=True)
        storeroom = Room("storeroom", "a small storage room with old computer stuff in it.", nintendo_switch)
